...
func createCustomer(db *db.PostgresDB, c *gin.Context) (int, *Customer, error) { // implement db layer
...
func getCustomer(db *db.PostgresDB, c *gin.Context) (int, *Customer, error) { // implement db layer
...
func updateCustomer(db *db.PostgresDB, c *gin.Context) (int, *Customer, error) { // implement db layer
	customerID := c.Param("customerId")
	id, err := strconv.Atoi(customerID)
	if err != nil {
		return http.StatusBadRequest, nil, err
...
func deleteCustomer(db *db.PostgresDB, c *gin.Context) (int, error) { // implement db layer
	customerID := c.Param("customerId")
	id, err := strconv.Atoi(customerID)
	if err != nil {
